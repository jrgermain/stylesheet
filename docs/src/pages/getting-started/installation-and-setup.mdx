...
This option is useful if you aren't using the tools above.

First, download the latest release of the stylesheet from the [releases page on GitHub](https://github.com/jrgermain/stylesheet/releases).
