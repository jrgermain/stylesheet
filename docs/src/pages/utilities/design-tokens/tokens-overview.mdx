...
Concord includes the following categories of tokens:
...
<div class="alert warning">
  <div class="alert-content">Avoid using CSS variables defined by Concord but not documented on this site; these aren't part of the public API and may change in between major releases.</div>
</div>
