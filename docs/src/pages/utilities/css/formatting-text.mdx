...
You can make text semibold by adding the class `semibold`.

<UsageExample
  name="Example"
  code={`
    <p class="paragraph">
      This text is <span class="semibold">semibold</span>.
    </p>
  `}
/>
...
You can add a gradient to text by adding the class `gradient-text`. 
...
You may choose to combine this with the `bold` or `semibold` classes
...
<UsageExample
  ...
  code={`
    <div style="display: flex; flex-direction: column; align-items: flex-start;">
      <p class="paragraph gradient-text">Default gradient</p>
      <p
        class="paragraph gradient-text"
        style="
          --gradient-text-start: var(--color-red-5);
          --gradient-text-middle: var(--color-red-4);
          --gradient-text-end: var(--color-red-3);
        "
      >
        Custom gradient
      </p>
